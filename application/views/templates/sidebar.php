<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <?php if ($this->session->userdata('username')) { ?>
        <li class="nav-item">Selamat Datang <div class="btn btn-sm btn-primary">
            <?= $this->session->userdata('username'); ?></div>
        </li>
      <?php } else { ?>
        <li class="nav-item">
          <?= anchor('admin/auth/prosese_login', '<div class="btn btn-sm btn-primary">Login
</div>'); ?></li>
      <?php } ?>
    </ul>
  </nav>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('admin/dashboard') ?>" class="brand-link">
      <img src="<?= base_url('/public/img/people5.jpg') ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
