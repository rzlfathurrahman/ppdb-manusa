       ...
       <div class="row mb-2">
         ...
         <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item"><a href="<?= base_url('admin/peserta') ?>">Calon Siswa</a></li>
     ...
     <?php foreach ($detail as $dt) : ?>
       <div class="card bg-light">
         ...
         <div class="card-body pt-0">
           <div class="row">
             <div class="col-12">
               <h2 class="lead text-uppercase"><b><?= $dt->nama_lengkap ?></b></h2>
               <p class="text-muted text-sm"><b>Kode Pendaftaran : </b> <?= $dt->kode_pendaftaran ?> </p>
               <p class="text-muted text-sm"><b>NIS : </b> <?= $dt->nis ?> </p>
               <table>
                 <tr>
         ...
         <div class="card-footer">
           <?= anchor('admin/peserta', '<div class="btn btn-sm btn-danger">Kembali' . '</div>'); ?>
         </div>
       </div>
       <!-- /.card-body -->
 </div>
