             ...
             <div class="card-body box-profile">
               <div class="text-justify">
                 ...
                 <?php if ($detail == NULL) {
                   ...
                   <?php $jNilai = 0;
                      foreach ($detail as $tn) : ?>
                     <ul class="list-group list-group-unbordered mb-3">
                       <li class="list-group-item">
                         <b>Bahasa Indonesia</b>
                         <a class="float-right"><?= $tn->nilai_bindo ?></a>
                       </li>
                       <li class="list-group-item">
                         <b>Matematika</b>
                         <a class="float-right"><?= $tn->nilai_mtk ?></a>
                       </li>
                       <li class="list-group-item">
                         <b>Ipa</b>
                         <a class="float-right"><?= $tn->nilai_ipa ?></a>
                       </li>
                       <li class="list-group-item">
                         <b>Bahasa Inggris</b>
                         <a class="float-right"><?= $tn->nilai_bing ?></a>
                       </li>
                     </ul>
                     <button class="btn btn-info btn-block"><strong>Total Nilai : <?= $jNilai = $tn->nilai_bindo + $tn->nilai_mtk + $tn->nilai_ipa + $tn->nilai_bing; ?></strong></button>
                   <?php endforeach; ?>
                 <?php } ?>
               </div>
               <!-- /.card-body -->
