	...
	<fieldset class="border-primary">
		<div class="table">	
			<div class="row">
				<div class="text-capitalize text-center col-md-12">
					<img src="<?php echo base_url('assets/uploads/')?>1200px-Nahdlatul_Ulama_Logo.svg.png" width="205px" class=" p-2 float-left" >
					<img src="<?php echo base_url('assets/img/')?>images.jpg" width="225px" alt="Logo Tuv" class="p-2 float-right" >
					...
					<ul class="list-unstyled mt-4 mb-4">
						<li>
							<span class="mt-3 font-weight-bold">
								 <u><h3>KEPUTUSAN PANITIA PPD</h3></u>	
							<span>
						</li>
						<li>
							<span class="text-center">NOMOR :
							 SMK/PPDB/<?php foreach ($detail as $dt) : ?><?php echo $dt->kode_pendaftaran ?><?php endforeach; ?>
							</span>
						</li>
					</ul>
					</span>
				...
				<div class="mx-auto mb-4 mt-3 col-md-12 text-center">
					<fieldset class="border ">
						<p class=" mt-4"><h3><strong>MEMUTUSKAN </strong></h3></p>
						<p><h3 class="font-weight-bold"><u>Diterima</u> / <strike>Tidak Diterima</strike></h3></p>
					</fieldset>
				</div>
				<div class="col-md-12 ">
					<table class="table">
								...
								<ol class="text-justify">
									<li>
									   <?php foreach ($detail as $dt): ?>
										<p>Nama : <b class="text-uppercase"><?php echo $dt->nama_lengkap ?></b></p>
										<p>Nomor Pendaftaran :
										    <b>
                                            	<?php echo $dt->kode_pendaftaran ?>
                                            </b>
										</p>
										<p>Diterima di Jurusan : </p>
										<p>
                                            ...
                                            <?php }else{ echo 'Jurusan TIdak Tersedia'; } ?>
										</p>
									</li>
							     <?php endforeach ?>
									<li>
		...
		<div class="row">
			<div class="col-sm-12 ">
				<ul class="list-unstyled float-right mr-4 text-justify">
					...
					<li>Tanggal : <b><?php echo date('d F Y') ?></b></li>
				</ul>
			</div>
		</div>
		...
		<div class="table">	
			<div class="row">
				<div class="text-capitalize text-center col-md-12">
					<img src="<?php echo base_url('assets/uploads/')?>1200px-Nahdlatul_Ulama_Logo.svg.png" width="205px" class=" p-2 float-left" >
					<img src="<?php echo base_url('assets/img/')?>images.jpg" width="250px" alt="Logo Tuv" class="p-2 float-right" >
					<p class="h4 font-weight-bold mt-3">PENERIMAAN PESERTA DIDIK (PPD)</p>
					<p class="h5 font-weight-bold">SMK MA'ARIF NU 1 AJIBARANG </p>
					<p class="h5 font-weight-bold">TAHUN AJARAN 2020/2021</p>
					<p class="text-muted">
