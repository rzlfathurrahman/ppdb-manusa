<div class="container-fluid">
  <div class="card m-3 ">
    ...
    <div class="card-body">
      ...
      <form class="needs-validation" novalidate action="<?= base_url('ppdb/daftar_aksi') ?>" method="post">
        ...
        <div class="form-group">
          ...
          <?= form_error('jk', '<div class="text-danger small ml-2 mt-2">', '
</div>') ?>
        </div>
        <div class="form-group">
